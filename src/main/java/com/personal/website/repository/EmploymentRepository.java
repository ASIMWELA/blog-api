...
public interface EmploymentRepository extends JpaRepository<EmploymentEntity, Long>
{
   ...
   void updateEmpInfo(@Param("compName") String newCompName, @Param("accompl") List<String> newAccomplishment, @Param("avail") String newAvail, @Param("dura") String newDuration, @Param("oldComName") String oldCompName );
}
